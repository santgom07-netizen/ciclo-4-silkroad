...
public class SilkRoad {
     ...
     * @throws IllegalArgumentException si hay error al parsear
     */
    private final void parseMarathonInput(String input) {
        try {
     ...
     */
    public final void placeStore(int location, int tenges) {
     ...
     * @throws IllegalArgumentException si ubicación o tenges inválidos
     */
    public final void placeStore(String type, int location, int tenges) {
     ...
     */
    public final void placeRobot(int location) {
     ...
     * @param location Ubicación del robot
     */
    public final void placeRobot(String type, int location) {
        if (location < 0 || location >= length) {
            ok = false;
            lastErrorMessage = "Ubicacion fuera de limites: " + location;
            showErrorIfVisible();
